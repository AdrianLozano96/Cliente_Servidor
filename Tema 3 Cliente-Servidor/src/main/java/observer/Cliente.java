...
public class Cliente implements Observer {
	...
	public void update(Observable o, Object arg) {
		//Si el arg es "stock hacer x.
		if (arg.equals("stock")) {
			System.out.println("El cliente ha sido notificado de un cambio en el stock de "+((Producto)o).getStock());
		}
		if (arg.equals("precio")){
			System.out.println("El cliente ha sido notificado de un cambio en el precio de "+((Producto)o).getPrecio());
		}
	}
}
