...
public class Producto extends Observable {
	...
	public void notifyObservers() {
		if (observer != null)
			//Reacciona cuando al llamar al método update le lleva el Object "stock".
			observer.update(this, "stock");
	}

	public void notifyObserversPrecio() {
		if (observer != null)
			//Reacciona cuando al llamar al método update le lleva el Object "precio".
